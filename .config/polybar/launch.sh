...
polybar --config=$HOME/.config/polybar/bars/notif_bar notif_bar >> /tmp/polybar_notifbar.log 2>&1 &
ln -s /tmp/polybar_mqueue.$! /tmp/notif_bar
sleep 0.1

polybar --config=$HOME/.config/polybar/bars/bottombar -r bottombar >> /tmp/polybar_bottombar.log 2>&1 &
ln -s /tmp/polybar_mqueue.$! /tmp/bottombar
sleep 0.1

polybar --config=$HOME/.config/polybar/bars/topbar -r topbar >> /tmp/polybar_topbar.log 2>&1 &
